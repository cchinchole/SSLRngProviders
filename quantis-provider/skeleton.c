...
static int seed_src_get_ctx_params(void *vseed, OSSL_PARAM params[])
{
    ...
    p = OSSL_PARAM_locate(params, "QuantisCardNo");
    if(p != NULL)
        printf("REQUEST HERE\n");
...
static int seed_src_set_ctx_params(void *vseed, OSSL_PARAM params[])
{
    ...
    p = OSSL_PARAM_locate_const(params, "QuantisCardNo");
    if(p != NULL)
    {
        int cardno;
...
static const OSSL_PARAM *seed_src_settable_ctx_params(void *vseed, void *provctx)
{
    static const OSSL_PARAM known_settable_ctx_params[] = {
        OSSL_PARAM_int("QuantisCardNo", NULL),
        OSSL_PARAM_END
    };
